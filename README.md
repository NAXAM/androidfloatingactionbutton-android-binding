...
Xamarin Binding Library for [futuresimple/android-floating-action-button](https://github.com/futuresimple/android-floating-action-button)
...
```
Install-Package Naxam.AndroidFloatingActionButton.Droid
```
